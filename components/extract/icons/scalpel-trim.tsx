...
export const ScalpelTrimIcon = ({
  ...
  >
    <g>
      <g>
        <path
          d="M315.571,896.423h-32c-17.9,17.6-37.5,32.3-58.9,44.2h90.9c5.5,0,10-4.5,10-10v-24.2
                    C325.571,900.923,321.071,896.423,315.571,896.423z"
        />
        <path
          d="M503.071,896.423h-122c-5.5,0-10,4.5-10,10v24.2c0,5.5,4.5,10,10,10h122c5.5,0,10-4.5,10-10v-24.2
                    C513.071,900.923,508.571,896.423,503.071,896.423z"
        />
        <path
          d="M690.571,896.423h-122c-5.5,0-10,4.5-10,10v24.2c0,5.5,4.5,10,10,10h122c5.5,0,10-4.5,10-10v-24.2
                    C700.571,900.923,696.071,896.423,690.571,896.423z"
        />
        <path
          d="M878.071,896.423h-122c-5.5,0-10,4.5-10,10v24.2c0,5.5,4.5,10,10,10h122c5.5,0,10-4.5,10-10v-24.2
                    C888.071,900.923,883.571,896.423,878.071,896.423z"
        />
        <path
          d="M316.171,792.324c66.101-128.4,86.601-162.301,113.101-181.5l-58.7-58.7l-369.1,369.1c-2.7,2.7-1.5,7.3,2.1,8.3
        ...
        />
        <path
          d="M901.371,37.624c-10.5-10.5-24.2-15.7-37.899-15.7c-13.7,0-27.4,5.2-37.801,15.7l-448.3,448.3
