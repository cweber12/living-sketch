  ...
  return (
    <>
          ...
          {user && (
            <>
              ...
              <form action={logout}>
                <button
                  type="submit"
                  className="btn-ghost rounded px-3 py-1.5 text-xs uppercase tracking-widest font-semibold"
                >
                  Sign Out
                </button>
              </form>
      ...
      <main className="flex flex-col flex-1">
        {/* ── Hero ──────────────────────────────────────────────────────── */}
        <section className="hero-grid relative flex flex-col items-center justify-center text-center px-6 py-24 min-h-[88vh]">
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  bones obey. Landmark frames are recorded and saved for
                  playback.
                </p>
              </div>
              <span
